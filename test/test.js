...
describe("API functional testing", function() {
  ...
  describe("List of posts - /api/v1/posts/", function() {
    it("get the list of posts tracked, should return 200", function(done) {
      api
        .get("/posts/")
        .set("Accept", "application/json")
        .set("Authorization", "Bearer " + fakeuser_token)
  ...
  describe("Add post - /api/v1/posts/", function() {
    it("add new post, should return 200", function(done) {
      api
        .post("/posts/")
        .set("Accept", "application/json")
        .set("Authorization", "Bearer " + fakeuser_token)
  ...
  describe("Update postzone - /api/v1/posts/:id", function() {
    it("update post, should return 200", function(done) {
      api
        .put("/posts/" + fakeentry_id)
        .send({
          distance: 25
        })
        .set("Authorization", "Bearer " + fakeuser_token)
  ...
  describe("Remove post - /api/v1/posts/:id", function() {
    it("delete post, should return 204", function(done) {
      api
        .delete("/posts/" + fakeentry_id)
        .set("Accept", "application/json")
        .set("Authorization", "Bearer " + fakeuser_token)
        .expect(204)
        .end(done);
