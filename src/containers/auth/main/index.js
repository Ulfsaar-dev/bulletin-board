    ...
    return (
      <div className="page f-align-center m-t-4 m-b-4">
        <Grid centered>
          ...
          <Grid.Column className="logout-form__container">
            <Segment padded="very">
              <Grid.Row>
                <Image
                  className="m-t-1 m-b-4"
                  src={logo}
                  size="small"
                  centered
                />
              ...
              <Grid.Row>
                ...
                >
                  ...
                  <Message error color="red">
                    {map(errors, err => (
                      <Message.Item key={err.message}>
                        {err.message}
                      </Message.Item>
                    ))}
                  </Message>
                  <Form.Button color="green" content="Login" fluid />
                </Form>
                <Divider horizontal section>
                  or
                </Divider>
                <label>Don't you have an account?</label>
                <Button color="green" fluid as={Link} to="/auth/signup">
                  Sign Up
                </Button>
              </Grid.Row>
            </Segment>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(AuthMain)
);
